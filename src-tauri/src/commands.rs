	...
	M: Params,
{
	tauri::generate_handler![
		...
		crate::bundles::get_bundles,
		crate::bundles::update_bundle,
		crate::bundles::paste_bundle,
		crate::bundles::import_bundle,
		crate::bundles::new_bundle,
		crate::bundles::check_bundle_collection,
